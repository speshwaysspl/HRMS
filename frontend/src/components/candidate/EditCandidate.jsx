    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/50 p-4">
      <div className="w-full max-w-2xl rounded-xl border border-surface-subtle bg-white p-6 md:p-8 shadow-panel relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-xl font-semibold text-ink">Edit Candidate Details</h3>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-xs font-semibold text-ink-muted uppercase mb-2">Status *</label>
              <select
                required
                className="w-full rounded-lg border border-surface-subtle bg-white px-4 py-3 text-ink outline-none focus:border-brand-500 text-sm"
                value={form.status}
            ...
            {form.status === "Interview Scheduled" && (
              <>
                <div>
                  <label className="block text-xs font-semibold text-ink-muted uppercase mb-2">Interview Date & Time *</label>
                  <input
                    type="datetime-local"
                    required
                    className="w-full rounded-lg border border-surface-subtle bg-white px-4 py-3 text-ink outline-none focus:border-brand-500 text-sm"
                ...
                <div>
                  <label className="block text-xs font-semibold text-ink-muted uppercase mb-2">Zoom Meeting Link *</label>
                  <input
                    type="url"
                    required
            ...
            <div>
              <label className="block text-xs font-semibold text-ink-muted uppercase mb-2">Password (Leave blank to keep unchanged)</label>

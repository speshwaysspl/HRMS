    ...
    <div className="container mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
      <div>
        <div className="flex items-center gap-3 mb-3">
          <img src={brandLogo} alt="Speshway HRMS" width="32" height="32" className="h-8 w-auto rounded-md" />
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li><Link to="/delete-account" className="text-white/60 hover:text-accent-500 transition-colors">Request Account Deletion</Link></li>
        </ul>
      </div>
    </div>
